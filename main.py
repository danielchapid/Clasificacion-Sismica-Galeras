...
FOLDERS = {
    "1": {
        ...
        "path": os.path.join(ROOT_DIR, "Códigos principales"),
        "scripts": [
    ...
    "2": {
        ...
        "path": os.path.join(ROOT_DIR, "Códigos secundarios"),
        "scripts": [
            ("dataset_viewer.py",        "Análisis exploratorio de datos (EDA)"),
            ("Random_forest.py",         "Ranking de importancia de características"),
