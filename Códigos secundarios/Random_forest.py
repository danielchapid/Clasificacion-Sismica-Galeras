...
# Add main scripts folder so config_Transformer can be imported
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "Códigos principales"))
...
import config_Transformer as config  # type: ignore
...
def load_context(partition: int):
    ...
    ctx_path = os.path.join(
        project_root, "data_processed", "partitions", 
